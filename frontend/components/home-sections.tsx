...
const serviceCards = [
  {
    ...
    description: 'Modern business websites that are fast, responsive, and conversion-focused.',
  },
  {
    icon: ReceiptText,
    title: 'POS Systems',
    description: 'Smart billing and inventory systems to simplify daily business operations.',
  },
  {
    icon: Palette,
    title: 'Branding & Design',
    description: 'Professional visual identity design to build trust and market recognition.',
  },
  {
    icon: Cpu,
    title: 'Custom Software',
    description: 'Tailored digital tools that solve real workflow challenges for your team.',
  },
]
  ...
  return (
    <>
      <section className="mx-auto mt-16 w-full max-w-[84rem] px-4 sm:px-6 md:mt-24">
        <div className={`${sectionLabelChipClassName} mx-auto mb-11`}>
          What We Offer
        </div>
      ...
      <section className="mx-auto mt-12 w-full max-w-[84rem] px-4 sm:px-6 md:mt-16">
        <div className="p-3 sm:p-6 md:p-10">
          <div className="mb-8 text-center">
            <p className={`${sectionLabelChipClassName} mx-auto mb-3`}>
              Process Flow
            </p>
