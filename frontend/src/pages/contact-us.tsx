      ...
      <PageContainer>
        ...
        <section className="mx-auto mt-16 w-full max-w-7xl px-4 sm:px-6 md:mt-20">
          <div className="grid gap-5 md:grid-cols-[1.2fr_1fr]">
            ...
            <StaggerParent className="grid gap-5">
              <StaggerItem>
                <InfoCard title="Phone" description="+94 74 152 5537">
                  <Phone className="mb-5 size-5 text-brand-muted" />
                </InfoCard>
              </StaggerItem>
              <StaggerItem>
                <InfoCard title="Email" description="hello@logozodev.com">
                  <Mail className="mb-5 size-5 text-brand-muted" />
                </InfoCard>
              </StaggerItem>
              <StaggerItem>
                <InfoCard title="Office" description="Tissamaharama, Sri Lanka">
                  <MapPin className="mb-5 size-5 text-brand-muted" />
                </InfoCard>
              </StaggerItem>
            </StaggerParent>
          </div>
