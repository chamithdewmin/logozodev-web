      ...
      <PageContainer>
        ...
        >
          <div className="flex flex-wrap gap-3">
            ...
            <a href="#application-form" className="rounded-full border border-white/15 bg-white/[0.03] px-6 py-3 text-base font-medium text-zinc-200 transition hover:bg-white/[0.06]">
              Send Your CV
            </a>
          </div>
        </PageHero>
        ...
        <section id="open-roles" className="mx-auto mt-24 w-full max-w-6xl scroll-mt-28 px-6">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {openings.map((role) => (
              <article key={role.title} className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/[0.04] to-white/[0.01] p-6">
                ...
                <a href="#application-form" className="mt-6 inline-flex rounded-full bg-white px-5 py-2.5 text-base font-medium text-black transition hover:bg-zinc-200">
                  Apply Now
                </a>
              </article>
            ))}
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.02] p-8 md:p-10">
            ...
            <form className="mt-7 space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                <label className="text-base text-zinc-300">Full Name<input type="text" className="mt-2 w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-base text-zinc-100 outline-none transition focus:border-white/30" placeholder="Your full name" /></label>
                <label className="text-base text-zinc-300">Email<input type="email" className="mt-2 w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-base text-zinc-100 outline-none transition focus:border-white/30" placeholder="you@example.com" /></label>
              </div>
              <div className="grid gap-4 sm:grid-cols-2">
                <label className="text-base text-zinc-300">Phone Number<input type="tel" className="mt-2 w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-base text-zinc-100 outline-none transition focus:border-white/30" placeholder="+94 ..." /></label>
                <label className="text-base text-zinc-300">Position Applying For<input type="text" className="mt-2 w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-base text-zinc-100 outline-none transition focus:border-white/30" placeholder="Frontend Developer Intern" /></label>
              </div>
              <label className="block text-base text-zinc-300">Portfolio / GitHub / Behance Link<input type="url" className="mt-2 w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-base text-zinc-100 outline-none transition focus:border-white/30" placeholder="https://..." /></label>
              <label className="block text-base text-zinc-300">Upload CV<input type="file" className="mt-2 w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-base text-zinc-100 outline-none file:mr-3 file:rounded-md file:border-0 file:bg-white file:px-3 file:py-1.5 file:text-base file:font-medium file:text-black" /></label>
              <label className="block text-base text-zinc-300">Short Message<textarea rows={4} className="mt-2 w-full resize-none rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-base text-zinc-100 outline-none transition focus:border-white/30" placeholder="Tell us about yourself and why you want to join LogozoDev." /></label>
              <button type="submit" className="rounded-full bg-white px-6 py-3 text-base font-medium text-black transition hover:bg-zinc-200">Submit Application</button>
            </form>
          </div>
        </section>
        ...
        <section className="mx-auto mt-20 w-full max-w-6xl px-6">
          <div className="rounded-3xl border border-white/10 bg-white/[0.02] p-10 text-center md:p-12">
            ...
            <div className="mt-8 flex justify-center">
              <a href="#application-form" className="rounded-full bg-white px-6 py-3 text-base font-medium text-black transition hover:bg-zinc-200">
                Send Your CV
              </a>
            </div>
          </div>
