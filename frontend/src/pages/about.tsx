      ...
      <PageContainer>
        ...
        <section className="mx-auto mt-16 w-full max-w-7xl px-4 sm:px-6 md:mt-20">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            <article className="rounded-3xl border border-brand-medium bg-gradient-brand-card-deep p-6 sm:p-7">
          ...
          <div className="rounded-3xl border border-brand-medium bg-gradient-brand-card-deep p-6 sm:p-8 md:p-10">
            ...
            <div className="mt-8 grid gap-6 lg:grid-cols-[1.05fr_1.95fr]">
              ...
              <div className="grid gap-4 md:grid-cols-2 md:gap-0">
                <article className="rounded-2xl border border-brand-medium bg-black/20 p-5 md:rounded-none md:border-y-0 md:border-l-0 md:border-r md:border-brand-medium md:bg-transparent md:px-6">
                  <div className="inline-flex size-12 items-center justify-center rounded-full border border-brand-medium bg-brand-frost shadow-brand-icon">
                ...
                <article className="rounded-2xl border border-brand-medium bg-black/20 p-5 md:rounded-none md:border-y-0 md:border-l-0 md:border-r-0 md:bg-transparent md:px-6">
                  <div className="inline-flex size-12 items-center justify-center rounded-full border border-brand-medium bg-brand-frost shadow-brand-icon">
                ...
                <article className="rounded-2xl border border-brand-medium bg-black/20 p-5 md:col-span-2 md:rounded-none md:border-x-0 md:border-b-0 md:border-t md:border-brand-medium md:bg-transparent md:px-6 md:pt-6">
                  <div className="inline-flex size-12 items-center justify-center rounded-full border border-brand-medium bg-brand-frost shadow-brand-icon">
