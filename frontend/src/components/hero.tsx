...
export function HeroSection() {
  return (
    <section className="relative min-h-screen w-full overflow-hidden px-4 pt-24 sm:px-6 md:px-10 md:pt-28">
      ...
      <div className="relative z-10 flex min-h-[calc(100vh-7rem)] w-full flex-col md:flex-row">
        <div className="flex flex-[1.1] flex-col justify-center py-4 md:p-14">
          <p className={`${sectionLabelChipClassName} mb-5`}>Spline 3D Integration</p>
