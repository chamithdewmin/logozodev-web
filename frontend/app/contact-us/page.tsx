          ...
          <div className="grid gap-5 md:grid-cols-[1.2fr_1fr]">
            <div className="rounded-3xl border border-white/10 bg-white/[0.02] p-6 sm:p-8 md:p-10">
              ...
              <form className="mt-7 space-y-4">
                ...
                <button
                  type="submit"
                  className="min-h-11 rounded-full bg-white px-6 py-3 text-base font-medium text-black transition hover:bg-zinc-200"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="grid gap-5">
              <InfoCard title="Phone" description="+94 74 152 5537">
                <Phone className="mb-5 size-5 text-zinc-300" />
              </InfoCard>
              <InfoCard title="Email" description="hello@logozodev.com">
                <Mail className="mb-5 size-5 text-zinc-300" />
              </InfoCard>
              <InfoCard title="Office" description="Tissamaharama, Sri Lanka">
                <MapPin className="mb-5 size-5 text-zinc-300" />
              </InfoCard>
            </div>
          </div>
        </section>
