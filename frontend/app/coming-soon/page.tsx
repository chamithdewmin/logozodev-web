      ...
      <PageContainer>
        <main className="mx-auto mt-10 w-full max-w-6xl px-6">
          <section className="rounded-3xl border border-white/10 bg-white/[0.02] p-10 md:p-14">
            <p className="inline-flex w-fit items-center rounded-full border border-white/10 bg-white/5 px-3.5 py-1 text-base text-zinc-300">
              Coming Soon
            </p>
            ...
            <p className="mt-5 max-w-3xl text-lg leading-relaxed text-zinc-400">
              We are currently preparing this page with detailed content and practical resources for our website.
              Meanwhile, you can explore our live services or contact us directly for support.
            </p>
