        ...
        <main className="mx-auto mt-10 w-full max-w-6xl px-6">
          <section className="rounded-3xl border border-white/10 bg-white/[0.02] p-8 md:p-12">
            ...
            <p className="mt-6 text-base leading-relaxed text-zinc-300">
              Welcome to LogozoDev. Your privacy is important to us. This Privacy Policy explains how we collect, use,
            ...
            <div className="mt-8 space-y-8 text-zinc-300">
              <section>
                ...
                <ul className="mt-3 list-disc space-y-2 pl-6 text-zinc-400">
                  ...
                  <li>Email address</li>
                  <li>Phone number</li>
                  <li>Project details or messages you send</li>
                  <li>Basic website usage data (cookies, analytics)</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="mt-3 list-disc space-y-2 pl-6 text-zinc-400">
                  ...
                  <li>Send updates (only if you agree)</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="mt-3 text-zinc-400">
                  We take reasonable steps to protect your personal information. However, no method of transmission
              ...
              <section>
                ...
                <p className="mt-3">We do NOT sell or share your personal information with third parties, except:</p>
                <ul className="mt-3 list-disc space-y-2 pl-6 text-zinc-400">
                  <li>When required by law</li>
                  <li>To deliver services (if needed)</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="mt-3 text-zinc-400">
                  We may use tools like Google Analytics or hosting services that collect basic usage data.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mt-3 text-zinc-400">Contact us anytime for these requests.</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-white">8. Contact Us</h2>
                <p className="mt-3 text-zinc-400">If you have any questions about this Privacy Policy, contact us:</p>
                <p className="mt-2 text-zinc-300">Email: hello@logozodev.com</p>
